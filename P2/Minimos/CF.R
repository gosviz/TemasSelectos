...
a2=m2$coef[3]
yc2 = a0 + a1*y + a2*y^2
yc2 = a0 + a1*ard + a2*ard^2
cat("\nsegundo a0= ",a0, " a1=", a1, " a2=", a2)
x11()
plot(yc2)
lines(yc2)
...
a2=m3$coef[3]
a3=m3$coef[4]
yc3 = a0 + a1*ard + a2*ard^2 + a3*ard^3
...
yc4 = a0 + a1*ard + a2*ard^2 + a3*ard^3 + a4*ard^4
cat("\ncuarto a0= ",a0, " a1=", a1, " a2=", a2, "a3= ", a3, "a4= ", a4)
x11()
plot(yc4)
lines(yc4)
